...
const NavDropdown = () => {
  ...
  return (
    <section
      className="absolute bg-white w-full lg:mt-4 lg:ml-0 lg:top-full md:top-0 md:mt-0 lg:left-0 md:ml-2 md:left-full top-full mt-2 left-0 rounded-box z-50 shadow-lg border h-56 overflow-y-scroll flex flex-col gap-y-4"
      onMouseLeave={() => {
