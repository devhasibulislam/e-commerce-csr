...
const StartExploring = () => {
  ...
  const explores = [
    {
      image: "/assets/explore/png/explore1.png",
      productCount: 222,
      title: "Manufacturer",
      header: "Car Coat",
      anchor: "/categories/car-coat",
      backgroundImage: "/assets/explore/svg/explore1.svg",
    },
    {
      image: "/assets/explore/png/explore2.png",
      productCount: 213,
      title: "Manufacturer",
      header: "Cycling Jersey",
      anchor: "/categories/cycling-jersey",
      backgroundImage: "/assets/explore/svg/explore2.svg",
    },
    {
      image: "/assets/explore/png/explore3.png",
      productCount: 149,
      title: "Manufacturer",
      header: "Cycling Shorts",
      anchor: "/categories/cycling-shorts",
      backgroundImage: "/assets/explore/svg/explore3.svg",
    },
    {
      image: "/assets/explore/png/explore4.png",
      productCount: 171,
      title: "Manufacturer",
      header: "Recycled Blanket",
      anchor: "/categories/recycled-blanket",
      backgroundImage: "/assets/explore/svg/explore4.svg",
    },
    {
      image: "/assets/explore/png/explore5.png",
      productCount: 283,
      title: "Manufacturer",
      header: "Shoes",
      anchor: "/categories/shoes",
      backgroundImage: "/assets/explore/svg/explore5.svg",
    },
    {
      image: "/assets/explore/png/explore6.png",
      productCount: 125,
      title: "Manufacturer",
      header: "Backpack",
      anchor: "/categories/backpack",
      backgroundImage: "/assets/explore/svg/explore6.svg",
    },
  ];
          ...
          {tabs.map((tab, index) => (
            <span
              ...
              className={`tab tab-lg tab-lifted whitespace-nowrap ${
                tabState === tab.title && "tab-active"
              }`}
              onClick={() => setTabState(tab.title)}
            >
